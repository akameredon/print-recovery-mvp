...
with tempfile.NamedTemporaryFile(suffix=".sqlite3") as handle:
    ...
    assert [version for version, _ in first] == [1, 2, 3, 4, 5, 6, 7, 8, 9]
    assert applied_versions(conn) == [1, 2, 3, 4, 5, 6, 7, 8, 9]
    ...
    conn.close()
print({"status": "passed", "versions": [1, 2, 3, 4, 5, 6, 7, 8, 9], "second_run": "idempotent"})
