...
browser_error = requests.get(BASE + "/does-not-exist", headers={"Accept": "text/html", "X-Correlation-ID": "day6-browser"})
...
internal = requests.get(BASE + "/api/diagnostics", headers={"Accept": "application/json", "X-Correlation-ID": "day6-internal"})
assert internal.status_code == 200
print({"status": "passed", "json_404": missing_body["error"], "json_405": wrong_body["error"], "browser_404": browser_error.status_code})
